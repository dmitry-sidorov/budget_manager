defmodule BudgetManagerWeb.Components.InputField do
  @moduledoc """
  The `BudgetManagerWeb.Components.InputField` module provides a customizable input field component that
