defmodule BudgetManagerWeb.Components.MegaMenu do
  @moduledoc """
  The `BudgetManagerWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
