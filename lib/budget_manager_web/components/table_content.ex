defmodule BudgetManagerWeb.Components.TableContent do
  @moduledoc """
  `BudgetManagerWeb.Components.TableContent` is a component module designed to create flexible and dynamic
