defmodule BudgetManagerWeb.Components.Chat do
  @moduledoc """
  `BudgetManagerWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
