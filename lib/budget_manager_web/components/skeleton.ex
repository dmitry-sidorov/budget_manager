defmodule BudgetManagerWeb.Components.Skeleton do
  @moduledoc """
  The `BudgetManagerWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
