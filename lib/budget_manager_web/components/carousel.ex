defmodule BudgetManagerWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `BudgetManagerWeb.Components.Carousel`
  project.
