defmodule BudgetManagerWeb.Components.Stepper do
  @moduledoc """
  The `BudgetManagerWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `BudgetManagerWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
