defmodule BudgetManagerWeb.Components.Overlay do
  @moduledoc """
  The `BudgetManagerWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `BudgetManagerWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
