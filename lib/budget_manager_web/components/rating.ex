defmodule BudgetManagerWeb.Components.Rating do
  @moduledoc """
  The `BudgetManagerWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
