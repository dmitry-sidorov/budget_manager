defmodule BudgetManagerWeb.Components.Image do
  @moduledoc """
  The `BudgetManagerWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
