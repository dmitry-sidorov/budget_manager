defmodule BudgetManagerWeb.Components.UrlField do
  @moduledoc """
  BudgetManagerWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
