defmodule BudgetManagerWeb.Components.Alert do
  @moduledoc """
  BudgetManagerWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
