defmodule BudgetManagerWeb.Components.Indicator do
  @moduledoc """
  The `BudgetManagerWeb.Components.Indicator` module provides a versatile component for visually highlighting
