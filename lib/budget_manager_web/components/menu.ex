defmodule BudgetManagerWeb.Components.Menu do
  @moduledoc """
  The `BudgetManagerWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  import BudgetManagerWeb.Components.Accordion, only: [accordion: 1]
  import BudgetManagerWeb.Components.Button, only: [button_link: 1]
