defmodule BudgetManagerWeb.Components.Banner do
  @moduledoc """
  BudgetManagerWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
