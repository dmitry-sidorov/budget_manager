defmodule BudgetManagerWeb.Components.NativeSelect do
  @moduledoc """
  The `BudgetManagerWeb.Components.NativeSelect` module provides a customizable native select component
