defmodule BudgetManagerWeb.Components.Spinner do
  @moduledoc """
  The `BudgetManagerWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `BudgetManagerWeb.Components.Spinner` module enables developers to provide
