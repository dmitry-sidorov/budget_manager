defmodule BudgetManagerWeb.Components.Breadcrumb do
  @moduledoc """
  Provides a flexible and customizable `BudgetManagerWeb.Components.Breadcrumb` component for displaying
