defmodule BudgetManagerWeb.Components.CheckboxField do
  @moduledoc """
  BudgetManagerWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
