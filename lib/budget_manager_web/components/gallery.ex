defmodule BudgetManagerWeb.Components.Gallery do
  @moduledoc """
  The `BudgetManagerWeb.Components.Gallery` module provides a customizable gallery component for displaying
