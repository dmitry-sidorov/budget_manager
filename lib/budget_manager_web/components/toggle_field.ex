defmodule BudgetManagerWeb.Components.ToggleField do
  @moduledoc """
  BudgetManagerWeb.Components.ToggleField component renders a toggle field with customizable options.
