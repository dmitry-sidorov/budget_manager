defmodule BudgetManagerWeb.Components.FileField do
  @moduledoc """
  The `BudgetManagerWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import BudgetManagerWeb.Components.Progress, only: [progress: 1]
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BudgetManagerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BudgetManagerWeb.Gettext, "errors", msg, opts)
    end
  end
