defmodule BudgetManagerWeb.Components.DeviceMockup do
  @moduledoc """
  The `BudgetManagerWeb.Components.DeviceMockup` module provides a customizable component for displaying
