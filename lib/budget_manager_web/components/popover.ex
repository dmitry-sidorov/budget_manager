defmodule BudgetManagerWeb.Components.Popover do
  @moduledoc """
  The `BudgetManagerWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
